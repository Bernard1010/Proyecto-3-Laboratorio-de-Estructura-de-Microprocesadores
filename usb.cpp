...
BITMAP *elimarchivos;																	//variable para guardar imagen de elimindadno archivos
BITMAP *errorcopia;																		//variable para guardar imagen de error 
...
string p1;																				//	
string resultado="/home/berni/Documentos/resultado";
string resultados="/home/berni/Documentos/resultados";
...
void cargasprites()
{
		...
		elimarchivos = load_bitmap("elimarchivos.bmp",NULL);							//^
...
{ 
		...
		system("mkdir /home/berni/Documentos/Proyecto_3");
...
while(true)																							//Espera Enter para salir
{
	...
	if(tecla1==KEY_T)
	{
			...
			draw_sprite(buffer,presscancel,1,200);
			textout_ex(buffer,font, "NUEVO DISPOSITIVO", 400, 20, makecol(0,255,0), -1);						//imorime nuevo dispositivo en pantalla
			...
			while(true)																							//ciclo para escoger si eleminar elementos y copiar o crear carpeta y copiar
			{
				...
				if(t==KEY_B)
				{
					...
					{
						draw_sprite(buffer,fondo,0,0);															//imprime fondo
						draw_sprite(buffer,errorcopia,150,10);													//imprime mensaje de error
						draw_sprite(buffer,elimarchivos,120,50);												//imprime mensaje de error
						draw_sprite(buffer,press,150,200);														//imprime mensaje de presione enter
						pantalla();																				//se muestra en pantalla
						bool V=true;
						while(!key[KEY_ENTER])																	//Espera Enter para salir
						{
							if(V)
							{
...
///////////////////////////////////////////////////ARCHIVOS SELECCIONADOS DEFINIDOS///////////////////////////////////////////////////////////////////
			...
			textout_ex(buffer,font, "NUEVO DISPOSITIVO", 400, 20, makecol(0,255,0), -1);								//imprime nuevo dispositivo en pantalla
			textout_ex(buffer,font, varusb, 400, 30, makecol(0,0,255), -1);												//imprime mensaje de presione c para cancelar
			pantalla();																									//muestra en pantalla
